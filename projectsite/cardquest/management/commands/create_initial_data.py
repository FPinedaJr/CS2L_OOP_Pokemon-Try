...
class Command(BaseCommand):
    ...
    def create_pokemon_cards(self):
        card1 = PokemonCard(name="Pikachu", rarity="R",hp=60, card_type="Electric", attack="Thunder Shock",
                            ...
                            abilities="Static")
        card2 = PokemonCard(name= "Charmeleon", rarity= "R",hp= 120, card_type= "Fire", attack= "Flamethrower", 
                            description= "It has a barbaric nature. In battle, it whips its fiery tail around and slashes away with sharp claws.", 
                            weakness= "Water",card_number= 5,release_date= "1996-02-27", evolution_stage= "Stage 2", abilities= "Solar Power")
        card3 = PokemonCard(name= "Mewtwo", rarity= "U",hp=  150, card_type= "Psychic", attack= "Psychic",
        ...
        card4 = PokemonCard(name= "Caterpie", rarity= "C",hp= 45, card_type= "Grass", attack= "Bug Bite", 
        ...
        card5 = PokemonCard(name= "Squirtle", rarity= "R",hp= 40, card_type= "Water",attack=  "Bubble", 
        ...
        card6 = PokemonCard(name= "Eevee",rarity= "R", hp= 50, card_type= "Normal", attack= "Tackle", 
        ...
        card7 = PokemonCard(name="Snorlax",rarity= "U",hp= 140,card_type= "Normal",attack= "Body Slam", 
        ...
        card8 = PokemonCard(name="Raikou",rarity= "R", hp= 90,card_type= "Electric",attack= "Thunder Fang",
        ...
        card9 = PokemonCard(name="Cryogonal",rarity= "R",hp= 80,card_type= "Ice",attack= "Aurora Beam",
        ...
        card10 = PokemonCard(name="Pancham",rarity= "U",hp= 67,card_type= "Fighting",attack= "Circle Throw",
        ...
        card11 = PokemonCard(name="Entei",rarity= "R",hp= 115,card_type= "Fire",attack= "Flame Wheel",
        ...
        card12 = PokemonCard(name="Suicune",rarity= "R",hp= 100,card_type= "Water",attack= "Hydro Pump",
        ...
        card13 = PokemonCard(name="Mudkip",rarity= "C",hp= 50,card_type= "Water",attack= "Watergun",
        ...
        card14 = PokemonCard(name="Meowth",rarity= "R",hp= 40,card_type= "Normal",attack= "Fake out",
        ...
        card15 = PokemonCard(name="Jigglypuf",rarity= "R",hp= 115,card_type= "Fairy",attack= "Disarming Voice",
        ...
        card16 = PokemonCard(name="Duskull",rarity= "C",hp= 20,card_type= "Ghost",attack= "Payback",
        ...
        card17 = PokemonCard(name="Wobbuffet",rarity= "R",hp= 190,card_type= "Psychic",attack= "Destiny Bond",
        ...
        card18 = PokemonCard(name="Darkrai",rarity= "R",hp= 70,card_type= "Dark",attack= "Dark Pulse",
        ...
        card19 = PokemonCard(name= "Totodile",rarity= "C",hp= 50,card_type= "Water",attack= "Water Gun",
        ...
        card20 = PokemonCard(name= "Deoxys",rarity= "R",hp= 50,card_type= "Psychic",attack= "Cosmic Power",
    ...
    def create_collection(self):
        ...
        collection = Collection(card=PokemonCard.objects.get('Pikachu'), trainer=Trainer.objects.get('Ash'), release_date='2023-12-12')
